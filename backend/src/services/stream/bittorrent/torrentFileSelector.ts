...
export class TorrentFileSelector {
  private static VIDEO_EXTENSIONS = ['.mp4', '.webm', '.mkv', '.avi', '.mov', '.m4v'];
   ...
   */
  public static selectMainVideoFile(files: TorrentStreamFile[]): TorrentStreamFile {
